...
define config.name = "Doom Doom Literature Club! Texas Street Law Battle!!"
...
define config.main_menu_music = audio.rt
...
define config.window_icon = "mod_assets/window_logo.png"
