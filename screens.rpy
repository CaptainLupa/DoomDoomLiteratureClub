...
init -1 style splash_sw:
    size 24
    color "#FFF"
    font "mod_assets/stj.ttf"
    text_align 0.5
    outlines []

init -1 style texasgame_text:
    yalign 0.5
    size 30
    font "mod_assets/texas.otf"
    color "#FFF"
    outlines []
...
init -1 style texasgame_large_text:
    yalign 0.5
    size 75
    font "mod_assets/texas.otf"
    color "#FFF"
...
init -1 style Round_text:
    yalign 0.5
    font "mod_assets/round.ttf"
    size 50
    color '#FFF'
    outlines []
...
init -1 style navigation_button_text:
    ...
    color "#fff"
    outlines [(4, "#ff0000", 0, 0), (2, "#ff0000", 2, 2)]
    hover_outlines [(4, "#ff5757", 0, 0), (2, "#ff5757", 2, 2)]
    insensitive_outlines [(4, "#ff8f96", 0, 0), (2, "#ff8f96", 2, 2)]
...
init -1 style game_menu_label_text:
    ...
    size gui.title_text_size
    color "#fff"
    outlines [(6, "#ff5757", 0, 0), (3, "#ff5757", 2, 2)]
    yalign 0.5
...
init -1 style pref_label_text:
    ...
    size 24
    color "#fff"
    outlines [(3, "#ff5757", 0, 0), (1, "#ff5757", 1, 1)]
    yalign 1.0
