label Mango:
    ...
    d "Will that be enough to stop Monika?"
    ...
    y "I thought you were the overlord?"
    ...
    y "Oh yes!  Of course, sorry, I had forgotten amongst all the excitment."
    n 5hmm "Amogus?{nw}"
    n 1a "{nw}"
    d "What was that Natsuki?"
    n "Absolutely nothing..."
    n "You are simply imagining things."
    d "Okay..."
    ...
    y "It takes such skill, even I can barely keep up with the master."
    d "I'm ready."
    y "So basically, there is some sort of judge presiding over the match, we are no animals."
    ...
    s "Seriously guys... You didn't pay this, what was it, Conky Crinkler, person any money did you?"
    y "Well of course, he must be compensated for his training in some way."
    "Oh Jesus."
    "Oh no."
    ...
    "God..."
    "This is horrible."
    s "Yuri it's ok, this kind of thing happens."
    "Sayori embraces Yuri in a deep hug."
    s "It's ok."
    "Yuri begins to cry."
    y "W-what w-ww-was I th-th-thinking..."
    y "*sniff*"
    y "Oh g-g-god..."
    y "aaaaah"
    ...
    n "But, I encouraged her to do all of it, I'm the one who introduced them."
    ...
    n "Oh yeah."
    n "But, Conky Crinkler is the one who told us that Monika is a genius at the game."
    d "Oh god their in league..."
    n "That would make sense..."
    "Natsuki begins to really cry now."
    n "D-D-Doomguy... What aa-are we g-g-onna d-do?"
