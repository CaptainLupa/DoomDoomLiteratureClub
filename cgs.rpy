...
transform s_kill_out:
    truecenter
    xalign 0.3 yalign 0.05 zoom 0.95

transform s_kill_mid:
    truecenter
    xalign 0.5 yalign 0.05 zoom 0.95

transform d_mid:
    truecenter
    xalign 0.5 yalign 0.15 zoom 0.35

transform S_Shake_Out:
    truecenter
    xalign 0.3 yalign 0.05 zoom 0.95
    linear 0.01 xalign 0.32 yalign 0.07 zoom 0.95
    linear 0.01 xalign 0.3 yalign 0.05 zoom 0.95
    linear 0.01 xalign 0.28 yalign -0.03 zoom 0.95
    repeat 5000
