...
transform tcommonRotate40d(x=640, z=0.80):
    yanchor 1.0 subpixel True
    on show:
        ypos 1.35
        zoom z*0.95 alpha 0.00
        xcenter x yoffset -20
        rotate 30
        easein .25 yoffset 0 zoom z*1.00 alpha 1.00 rotate 30
    on replace:

        alpha 1.00
        parallel:
            easein .25 xcenter x zoom z*1.00 rotate 30
        parallel:
            easein .15 yoffset 0 ypos 1.35 rotate 30

transform unrotate(x=640, z=0.80):
    yanchor 1.0 subpixel True
    on show:
        ypos 1.35
        zoom z*0.95 alpha 0.00
        xcenter x yoffset -20
        rotate 0
        easein .25 yoffset 0 zoom z*1.00 alpha 1.00 rotate 0
    on replace:

        alpha 1.00
        parallel:
            easein .25 xcenter x zoom z*1.00 rotate 0
        parallel:
            easein .15 yoffset 0 ypos 1.25 rotate 0

transform anger(x=640, z=0.80):
    xcenter x yoffset 0 yanchor 1.0 ypos 1.03 zoom z*1.00 alpha 1.00 subpixel True
    block:
        linear 0.10 xcenter x + 15 yoffset -2
        pause 0.05
        linear 0.10 xcenter x yoffset 0
        pause 0.05
        linear 0.10 xcenter x - 15 yoffset -2
        pause 0.05
        linear 0.10 xcenter x yoffset 0
...
transform leftright_slide(x=640, x2=640, z=0.80):#works both directions, just have to get pixel(?) alignments correct
    xcenter x yoffset 0 yanchor 1.0 ypos 1.03 zoom z*1.00 alpha 1.00 subpixel True
    easein .25 xcenter x2

transform rightin(x=640, z=0.80):
    xcenter 750 yoffset 0 yanchor 1.0 ypos 1.03 zoom z*1.00 alpha 1.00 subpixel True
    easein .25 xcenter x
...
transform tr41:
    tcommonRotate40d(200)
transform tr42:
    tcommonRotate40d(493)
transform tr43:
    tcommonRotate40d(786)
transform tr44:
    tcommonRotate40d(1080)
transform tr31:
    tcommonRotate40d(240)
transform tr32:
    tcommonRotate40d(640)
transform tr33:
    tcommonRotate40d(1040)
transform tr21:
    tcommonRotate40d(400)
transform tr22:
    tcommonRotate40d(880)
transform tr11:
    tcommonRotate40d(640)
...
transform l11:
    leftin(640)
transform lr44:
    leftright_slide(200, 925)#41 position to 925
transform lr22:
    leftright_slide(400, 745)#21 position to 745
transform lr43_nyK:
    leftright_slide(645, 786)#645 to 786, sliding from left to right
transform lr43_syH:
    leftright_slide(295, 786)#295 to 786, sliding from left to right
transform lrn_syH:
    leftright_slide(493, 600)#493 to 600, sliding from left to right
...
transform r11:
    rightin(640)
transform r_nyK:
    leftright_slide(786, 645)#sliding to 645, right to left
transform r_ysH:
    leftright_slide(786, 295)#sliding to 295, right to left
transform r_nysH:
    leftright_slide(600, 493)
